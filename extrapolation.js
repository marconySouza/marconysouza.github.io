        ...
        gf: function(a) {
            ...
            switch (c) {
                ...
                case "colors":
                    ...
                    break;
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]), null != a && -2000 <= a && 2000 >= a ? (n.A.rd.Xa(a), this.ya.gm(a), this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value between -200 and 50 milliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                    break;
                case "handicap":
